...
public class MainApplet extends JApplet implements IFPSEvents, Data.Events.IDBEvent
{
	 ...
	 * @throws Exception
	 */
	public MainApplet() throws Exception
	{
		initialize();
	...
	{
		setName("FAA Flight Planing System (FPS)");
		// setResizable(false);
