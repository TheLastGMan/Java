 ...
 */
public class Dictionary<TKey extends Comparable<TKey>, TValue> extends IDictionary<TKey, TValue> implements Serializable
{
	// IReadOnlyDictionary<TKey, TValue>, IDeserializationCallback
	 ...
	 *
	 * @return The number of key/value pairs contained in the Dictionary(Of TKey, TValue).
	 */
	@Override
	public int Count()
	{
	 ...
	 *
	 * @return collection containing the keys in the Dictionary(Of TKey, TValue).
	 */
	@Override
	public ICollection<TKey> Keys()
	{
		return new List<>(_hashtable.keySet());
	}

	/**
	 * Gets a collection containing the values in the Dictionary(Of TKey, TValue).
	 *
	 * @return collection containing the values in the Dictionary(Of TKey, TValue).
	 */
	@Override
	public ICollection<TValue> Values()
	{
		return new List<>(_hashtable.values());
	}
	 ...
	 * @return value associated with the specified key. if the key is not found, and an exception is thrown
	 * @throws Exception
	 *             Error
	 */
	@Override
	 ...
	 * @return T/F if the dictionary contains an element with the specified value
	 */
