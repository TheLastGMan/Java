...
public class KeyValuePair<TKey, TValue> implements Serializable {
	...
	/**
	 * Initializes a new instance of the KeyValuePair<TKey, TValue> structure
	...
	/**
	 * Returns a string representation of the KeyValuePair(Of TKey, TValue),
	 * using the string representations of the key
	 * and value.
	 *
	 * @return A string representation of the KeyValuePair(Of TKey, TValue),
	 *         which includes the string representations
